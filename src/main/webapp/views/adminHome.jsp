			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link" href="/adminhome">Home
							Page</a></li>
					<li class="nav-item active"><a class="nav-link" href="/adminlogin">Logout</a></li>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">View all the customer here.</p>
						<a href="/admin/customers" class="card-link btn btn-primary">View</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">View Timing Here..</p>
						<a href="/admin/timing" class="card-link btn btn-primary">View</a>
